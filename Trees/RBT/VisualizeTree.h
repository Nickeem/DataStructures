...
//  DrawTree
//
//  Created by Dr. John Charlery on 10/24/2021.
//  Copyright (c) 2021 University of the West Indies. All rights reserved.
//

#ifndef DrawTree_VISUALIZETREE_H
#define DrawTree_VISUALIZETREE_H
...
string displayTree(Tree* ptr)
    {
        ...
        if (ptr->getRoot() == NULL) return str;
